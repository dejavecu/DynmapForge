 ...
 */
public class ForgeMapChunkCache extends CoreMapChunkCache implements MapChunkCache
{
    ...
    public NBTTagCompound readChunk(int x, int z) {
        if((cps == null) ||
                ...
                (syncLockObject == null) || (currentchunkloader == null) || (chunkSaveLocation == null)) {
            return null;
        }
        try {
            ...
            if (rslt == null) {
                File f = (File)chunkSaveLocation.get(acl);
                
                DataInputStream str = RegionFileCache.getChunkInputStream(f, x, z);
